...
<Deck>
  <Slide>
    <div class="flex flex-col min-h-screen justify-center">
      ...
      >
        Just a collection of slides created with <a
          href="https://svelte.dev/"
          class="text-blue-600 hover:text-neutral-600">Svelte</a
        >
        and
        <a
          href="https://unocss.antfu.me/"
          class="text-blue-600 hover:text-neutral-600">UnoCSS</a
        >.
        <br />
      ...
      <p
        class="font-sans font-normal text-center text-lg text-gray-300 max-w-4/6 mx-auto mt-8 leading-relaxed"
      >
        Press the right-left key to navigate or tap the right-left side of the
        screen
      </p>
    </div>
  </Slide>
      ...
      <div class="xl:w-11/24 w-22/24">
        ...
        >
          ...
          >
            ...
            <p class="font-sans font-light text-gray-500 mt-4 leading-relaxed">
              To turn the text in red after 1 transition, use the class
              `start-1:text-red`. You can use `start-2:...` for the second
              transition... Use as many as you wish.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p class="font-sans font-light text-gray-500 mt-4 leading-relaxed">
              With the `end-1:...` you can remove classes from your HTML. This
              is very useful when you are working with animate.css.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-col min-h-screen justify-center">
      ...
      >
        ...
        <p
          class="font-sans font-light text-xl text-gray-500 mt-8 leading-relaxed"
        >
          A picture is worth a thousand words. Illustrate your point with a
          background image. Then place whatever you want on top of it.
        </p>
      </div>
    </div>
  </Slide>
    ...
    >
      ...
      >
        ...
        <div class="flex flex-col">
          ...
          >
            `Deck` and `Slide` are the main components. More components will
            come to support charts and visualization tools
          </p>
          <a
            href="https://github.com/AlexandreKempf/svelte-slides"
      ...
      >
        ...
        <div class="flex flex-col">
          ...
          <p
            class="font-sans font-normal text-lg text-gray-500 mt-8 leading-relaxed"
          >
            Display your presentations on mobile or tablet. It is completely
  ...
  <Slide>
    <div class="flex flex-col min-h-screen justify-center">
      ...
      <p
        class="font-sans font-normal text-center text-lg text-gray-500 max-w-4/6 mx-auto mt-8 leading-relaxed"
      >
        Brief list of features that could be nice to have or that is already
        included:
      </p>
      <div class="flex flex-wrap justify-center mt-8">
        ...
        >
          ...
          <h2 class="font-sans font-normal text-neutral-900 mt-6 text-2xl">
            CSS animations
          </h2>
        </div>
        <div
